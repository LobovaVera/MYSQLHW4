...
SELECT mark, color, count(mark and color) FROM auto WHERE mark = 'BMW' OR mark = 'LADA' group by mark, color;

-- 2. Вывести на экран марку авто и количество AUTO не этой марки

select mark, (select count(*) from auto as total) - count(*) as remainings from auto group by mark;